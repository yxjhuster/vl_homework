...
def main():
    ...
    train_dataset_mix = tf.data.Dataset.from_tensor_slices((train_images, train_labels))
    ...
    for ep in range(args.epochs):
        ...
        for batch, ((images, labels), (images_mix, labels_mix)) in enumerate(zip(train_dataset, train_dataset_mix)):
