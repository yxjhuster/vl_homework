...
def main():
    ...
    parser.add_argument('--eval-interval', type=int, default=50,
                        help='how many batches to wait before'
                             ' evaluate the model')
    parser.add_argument('--log-dir', type=str, default='tb/02',
                        help='path for logging directory')
    parser.add_argument('--data-dir', type=str, default='./VOCdevkit/VOC2007',
                        help='Path to PASCAL data storage')
    parser.add_argument('--checkpoint-dir', type=str, default='./checkpoints/02/',
    ...
    for ep in range(args.epochs):
        ...
        for batch, (images, labels, weights) in enumerate(train_dataset):
            ...
            # if global_step.numpy() % args.save_interval == 0:
