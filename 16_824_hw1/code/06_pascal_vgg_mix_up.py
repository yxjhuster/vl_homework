...
class SimpleCNN(keras.Model):
    def __init__(self, pretrain_dir, scratch_dir, num_classes=10):
        super(SimpleCNN, self).__init__(name='SimpleCNN')
        self.num_classes = num_classes
        f = h5py.File(pretrain_dir)
        s = h5py.File(scratch_dir)
        self.conv1_1 = layers.Conv2D(filters=64,
                                   kernel_size=[3, 3],
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block1_conv1']['block1_conv1_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block1_conv1']['block1_conv1_b_1:0'].value))
        ...
        self.conv1_2 = layers.Conv2D(filters=64,
                                   ...
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block1_conv2']['block1_conv2_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block1_conv2']['block1_conv2_b_1:0'].value)                                   )
        ...
        self.conv2_1 = layers.Conv2D(filters=128,
                                   ...
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block2_conv1']['block2_conv1_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block2_conv1']['block2_conv1_b_1:0'].value))
        self.conv2_2 = layers.Conv2D(filters=128,
                                   kernel_size=[3, 3],
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block2_conv2']['block2_conv2_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block2_conv2']['block2_conv2_b_1:0'].value))
        ...
        self.conv3_1 = layers.Conv2D(filters=256,
                                   ...
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block3_conv1']['block3_conv1_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block3_conv1']['block3_conv1_b_1:0'].value))
        self.conv3_2 = layers.Conv2D(filters=256,
                                   kernel_size=[3, 3],
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block3_conv2']['block3_conv2_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block3_conv2']['block3_conv2_b_1:0'].value))
        self.conv3_3 = layers.Conv2D(filters=256,
                                   kernel_size=[3, 3],
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block3_conv3']['block3_conv3_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block3_conv3']['block3_conv3_b_1:0'].value))
        ...
        self.conv4_1 = layers.Conv2D(filters=512,
                                   ...
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block4_conv1']['block4_conv1_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block4_conv1']['block4_conv1_b_1:0'].value))
        self.conv4_2 = layers.Conv2D(filters=512,
                                   kernel_size=[3, 3],
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block4_conv2']['block4_conv2_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block4_conv2']['block4_conv2_b_1:0'].value))
        self.conv4_3 = layers.Conv2D(filters=512,
                                   kernel_size=[3, 3],
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block4_conv3']['block4_conv3_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block4_conv3']['block4_conv3_b_1:0'].value))
        ...
        self.conv5_1 = layers.Conv2D(filters=512,
                                   ...
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block5_conv1']['block5_conv1_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block5_conv1']['block5_conv1_b_1:0'].value))
        self.conv5_2 = layers.Conv2D(filters=512,
                                   kernel_size=[3, 3],
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block5_conv2']['block5_conv2_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block5_conv2']['block5_conv2_b_1:0'].value))
        self.conv5_3 = layers.Conv2D(filters=512,
                                   kernel_size=[3, 3],
                                   padding="same",
                                   activation='relu',
                                   kernel_initializer = keras.initializers.Constant(f['block5_conv3']['block5_conv3_W_1:0'].value),
                                   bias_initializer=keras.initializers.Constant(f['block5_conv3']['block5_conv3_b_1:0'].value))
        ...
        self.dense1 = layers.Dense(4096, activation='relu',
                                  kernel_initializer = keras.initializers.Constant(f['fc1']['fc1_W_1:0'].value),
                                  bias_initializer=keras.initializers.Constant(f['fc1']['fc1_b_1:0'].value))
        self.dropout1 = layers.Dropout(rate=0.5)
        self.dense2 = layers.Dense(4096, activation='relu',
                                  kernel_initializer = keras.initializers.Constant(f['fc2']['fc2_W_1:0'].value),
                                  bias_initializer=keras.initializers.Constant(f['fc2']['fc2_b_1:0'].value))
        self.dropout2 = layers.Dropout(rate=0.5)
        self.dense3 = layers.Dense(num_classes,
                                  kernel_initializer = keras.initializers.Constant(s['dense_2']['SimpleCNN/dense_2/kernel:0'].value),
                                  bias_initializer=keras.initializers.Constant(s['dense_2']['SimpleCNN/dense_2/bias:0'].value))
...
def main():
    ...
    parser.add_argument('--eval-interval', type=int, default=60,
                        help='how many batches to wait before'
                             ' evaluate the model')
    parser.add_argument('--log-dir', type=str, default='tb/05',
                        help='path for logging directory')
    parser.add_argument('--data-dir', type=str, default='./VOCdevkit/VOC2007',
                        help='Path to PASCAL data storage')
    parser.add_argument('--checkpoint-dir', type=str, default='./checkpoints/06',
                        help='Path to checkpoints storage')
    parser.add_argument('--save-interval', type=int, default=2,
                        help='How many batch to wait before storing checkpoints')
    parser.add_argument('--pretrain-dir', type=str, default='./pre_trained_model/vgg16_weights_tf_dim_ordering_tf_kernels.h5',
                        help='path the pretrained model')
    parser.add_argument('--scratch-dir', type=str, default='./checkpoints/04/ckpt.h5',
                        help='path the scratched model')
    args = parser.parse_args()
    util.set_random_seed(args.seed)
    sess = util.set_session()

    model = SimpleCNN(pretrain_dir=args.pretrain_dir, scratch_dir = args.scratch_dir,num_classes=len(CLASS_NAMES))
    ...
    train_dataset_mix = tf.data.Dataset.from_tensor_slices((train_images, train_labels, train_weights))
    ...
    learning_rate_decay = tf.train.exponential_decay(args.lr, global_step, 1000, 0.5)
    ...
    for ep in range(args.epochs):
        ...
        for batch, ((images, labels, weights), (images_mix, labels_mix, weights_mix)) in enumerate(zip(train_dataset, train_dataset_mix)):
            ...
            images=images * lamb[:, np.newaxis, np.newaxis, np.newaxis] + images_mix * (1-lamb)[:,np.newaxis,np.newaxis, np.newaxis]
            # print(images.shape)
            weights=weights * lamb[:, np.newaxis] + weights_mix * (1. - lamb)[:,np.newaxis]

            labels=labels * lamb[:, np.newaxis] + labels_mix* (1.- lamb)[:,np.newaxis]
